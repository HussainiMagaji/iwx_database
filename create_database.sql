...
CREATE TABLE suppliers (
  ...
  supplier_account_number  CHAR(10)                        NOT NULL,
  supplier_phone_number    VARCHAR(25)                     NOT NULL,
  CONSTRAINT suppliers_pk PRIMARY KEY (supplier_id)
);
LOAD DATA INFILE '/programData/MySQL/MySQL Server 8.0/Uploads/suppliers.csv'
...
LOAD DATA INFILE '/programData/MySQL/MySQL Server 8.0/Uploads/categories.csv'
